...
#Converting ratings to binary liked or not liked
...
#Creating architectur for our neural network
class RBM():
...
hidden_nodes=100
batch_size=100
rbm=RBM(len(training_set[0]),hidden_nodes)
#Training the model
nb_epochs=10
...
#testing out our recommender system
